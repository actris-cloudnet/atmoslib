...
| `barometric_pressure_profile(t, q, z, p_sfc)` | Pressure profile from surface value via hypsometric equation (Pa)        |
...
| `gas_specific_attenuation(p, e, t, f)`        | Dry-air + water-vapor specific attenuation (dB km⁻¹, ITU-R P.676)        |
