...
- Add `isa_temperature` and `isa_air_density` functions

## 2.4.1 – 2026-05-04

- Validate frequency in attenuation functions

## 2.4.0 – 2026-05-03

- Add ITU-R P.838-3 rain specific attenuation

## 2.3.2 – 2026-05-02

- Fix isa_altitude to invert hypsometric formula at observed altitude
